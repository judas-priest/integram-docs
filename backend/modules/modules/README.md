...
| [presence](presence.md) | `modules/presence/` | User online/activity status |
...
| [error-collector](error-collector.md) | `modules/error-collector/` | Frontend/backend error collection with fingerprint dedup |
