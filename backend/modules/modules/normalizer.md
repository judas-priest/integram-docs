...
Supports: PDF (pdf-parse), DOCX (mammoth), Excel/XLSX (xlsx library), CSV (papaparse), images (Tesseract OCR). Has file size limit and encoding detection. Returns plain text for LLM processing.
