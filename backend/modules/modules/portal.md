...
| Method | Path | Description |
|--------|------|-------------|
| GET | `/portal/api/config` | Portal config (pages, modules, theme, connectors flags) |
...
Executes `api/<name>.js` from the specified codespace repo in an isolated V8 sandbox. See [`docs/codespace-server-functions.md`](../../../docs/codespace-server-functions.md) and [`codespace.md`](codespace.md) (Server Functions section).
