...
MCP-сервер превращает все 740 инструментов Integram в MCP-инструменты. Работает через stdio.
...
Агент понимает естественный язык, умеет создавать таблицы, заполнять данные, строить отчёты, запускать портал — всё через те же 740 инструментов.
...
| `GET /api/v2/openapi.json` | Полная OpenAPI-спецификация (тегов: 46, endpoints: 693) |
