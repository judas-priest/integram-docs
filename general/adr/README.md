...
| [030](030-virtual-tables.md) | Виртуальные таблицы: типы без строк в EAV, состав из сателлитных таблиц | accepted |
| [031](031-org-workspace-many-to-many.md) | Организация ↔ область многие-ко-многим: junction `_v2_org_workspaces`, роль = MAX по всем организациям области | accepted |
| [032](032-org-cross-workspace-reads.md) | Кросс-воркспейсное чтение областей организации: судья — видимость области, гранты области не перепроверяются | accepted |
| [033](033-row-versions.md) | Версионность строки с подчинёнными таблицами — снимок + восстановление, не копии в EAV | accepted |
...
| 034 | [PM-мосты песочниц — pmQuery/pmCreate](034-pm-sandbox-bridges.md) | Accepted |
