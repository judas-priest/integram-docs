...
### computed-reqs
Виртуальные колонки: LOOKUP (значение из связанного объекта), ROLLUP (агрегат по связанным), FORMULA (вычисляемое выражение). Граф зависимостей с топологической сортировкой.
...
### presence
Онлайн-статус и активность пользователей.
